...
class HawksSettings(Settings):
  def __init__(self):
    ...
    self.set("decompose", False, helptext="Display is a chain of two 64x32 RGB LED matrices arranged to form a big square", choices=[False, True])
    ...
    self.set("animation", "none", helptext="Options are \"waving\" or \"none\"", choices=["none", "waving"])
    ...
    self.set("disc", False, helptext="Display is a 255-element DotStar disc", choices=[False, True])
    self.set("transpose", "none", helptext="PIL transpose operations are supported", choices=["none", "FLIP_LEFT_RIGHT", "FLIP_TOP_BOTTOM", "ROTATE_90", "ROTATE_180", "ROTATE_270", "TRANSPOSE"])
    self.set("rotate", 0, helptext="Rotation in degrees")
    self.set("mock", False, helptext="Display is mock rgbmatrix", choices=[False, True])
    self.set("mode", "text", helptext="Valid modes are 'text', 'file', and 'network_weather'", choices=["text", "file", "network_weather"])
